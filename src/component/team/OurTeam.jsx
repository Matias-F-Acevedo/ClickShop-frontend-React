...
const Ourteam = () => {
  const members = [
    ...
    },
    {
      ...
      Linkedin:
        "https://ar.linkedin.com/in/matias-cagliero-6585921b4?trk=public_profile_browsemap-profile",
    },
    {
      img: Matu,
      ...
      Linkedin:
        "https://www.linkedin.com/in/matías-acevedo?miniProfileUrn=urn%3Ali%3Afs_miniProfile%3AACoAAEMegEgB-VpzGrcQ2pCtuIr7xF3mB733b00&lipi=urn%3Ali%3Apage%3Ad_flagship3_search_srp_all%3BG2rPTiO%2FSGi0tWcMVhHP6A%3D%3D}",
    },
    {
      img: Sofia,
      name: "Sofia Belocchi",
